...
export class PathHandler {
    workspaceBasePath;
    archivedBasePath;
    constructor(workspaceBasePath, archivedBasePath) {
     ...
     */
    getAbsolutePath(normalizedPath) {
     ...
     */
    async generateUniqueArchivePath(normalizedPath) {
     ...
     */
    async checkFileExists(absolutePath) {
        try {
