...
import { readSection, replaceSectionBody, insertRelative, renameHeading, deleteSection } from './sections.js';
import { titleToSlug } from './slug.js';
import { createSilentLogger, setGlobalLogger } from './utils/logger.js';
let tempDir;
let TEST_FILE;
let WORKING_FILE;
let REL_WORKING_FILE;
beforeAll(() => {
...
describe('File Operations', () => {
    test('should handle file mtime preconditions', async () => {
        ...
        await expect(writeFileIfUnchanged(REL_WORKING_FILE, snap1.mtimeMs, 'Another update')).rejects.toThrow('File has been modified by another process');
    });
});
...
//# sourceMappingURL=markdown-tools.test.js.map