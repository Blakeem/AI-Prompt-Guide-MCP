 ...
 */
export async function performSectionEdit(manager, normalizedPath, sectionSlug, content, operation, title) {
    ...
    if (removeOperations.includes(operation)) {
        ...
        if (section == null) {
            throw new AddressingError(`Section not found: ${sectionSlug}`, 'SECTION_NOT_FOUND', {
                slug: sectionSlug,
        ...
        const absolutePath = manager.pathResolver.resolve(normalizedPath);
        ...
        if (title == null || title === '') {
            throw new AddressingError(`Title is required for creation operation: ${operation}`, 'MISSING_PARAMETER', { operation, requiredParameter: 'title' });
        }
        ...
        await manager.insertSection(normalizedPath, targetSlug, insertMode, undefined, // Let it auto-calculate depth
        ...
        if (operation === 'replace') {
            ...
            if (operation === 'append') {
                ...
                throw new AddressingError(`Invalid operation: ${operation}`, 'INVALID_OPERATION', { operation, validOperations: ['replace', 'append', 'prepend'] });
            }
        ...
        throw new AddressingError(`Invalid operation: ${operation}`, 'INVALID_OPERATION', { operation, validOperations });
    }
}
//# sourceMappingURL=section-operations.js.map