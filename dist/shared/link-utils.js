 ...
 */
export function parseLink(linkText, currentDocPath) {
    // Input validation
 ...
 */
export function resolveLink(link, currentDocPath) {
    // Input validation
 ...
 */
export async function validateLink(linkPath, manager) {
    // Input validation
 ...
 */
export async function linkExists(linkPath, manager) {
    try {
 ...
 */
export async function resolveLinkWithContext(linkText, currentDocPath, manager, options = {}) {
    // Parse the link
    ...
    if (options.includeSuggestions === true && validation.valid) {
        try {
            context = await loadLinkContext(resolvedPath, currentDocPath, manager, options);
        }
        catch (error) {
 ...
 */
async function loadLinkContext(_resolvedPath, _currentDocPath, _manager, _options) {
 ...
 */
function isExternalLink(linkPath) {
