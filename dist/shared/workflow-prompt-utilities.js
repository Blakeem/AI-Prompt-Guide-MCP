 ...
 */
import { getWorkflowPrompt } from '../prompts/workflow-prompts.js';
 ...
 */
export function extractWorkflowName(content) {
 ...
 */
export function extractMainWorkflowName(content) {
    // Check if field exists with or without value using flexible regex
 ...
 */
export function resolveWorkflowPrompt(workflowName) {
 ...
 */
export function enrichTaskWithWorkflow(taskData, taskContent) {
 ...
 */
export async function enrichTaskWithMainWorkflow(manager, document, taskData) {
    try {
        ...
        const firstTaskContent = await manager.getSectionContent(document.metadata.path, firstTask.slug);
...
//# sourceMappingURL=workflow-prompt-utilities.js.map