...
describe('AddressCache LRU Implementation', () => {
    ...
    test('should maintain access order for section cache', async () => {
        ...
        await Promise.all(sections.map(section => parseSectionAddress(section, contextDoc)));
    ...
    test('should handle cache eviction properly when size limit reached', async () => {
        ...
        if (doc0 != null)
            parseDocumentAddress(doc0);
        if (doc5 != null)
            parseDocumentAddress(doc5);
        if (doc9 != null)
            parseDocumentAddress(doc9);
    ...
    test('should handle hierarchical section caching correctly', async () => {
        ...
        if (firstHierSection != null)
            parseSectionAddress(firstHierSection, contextDoc);
        if (thirdHierSection != null)
            parseSectionAddress(thirdHierSection, contextDoc);
    ...
    test('should handle mixed flat and hierarchical section caching', async () => {
        ...
        if (troubleshootingSection != null)
            parseSectionAddress(troubleshootingSection, contextDoc);
        if (authSection != null)
            parseSectionAddress(authSection, contextDoc);
        if (overviewSection != null)
            parseSectionAddress(overviewSection, contextDoc);
...
//# sourceMappingURL=addressing-system.lru.test.js.map