 ...
 */
export function createDocumentManager(docsRoot) {
    ...
    const cache = createDocumentCache(root, {
        maxCacheSize: 100,
        enableWatching: true,
    ...
    void fingerprintIndex.initialize().catch((error) => {
    ...
    setTimeout(() => {
        ...
        if (watcher != null) {
            fingerprintIndex.watchFiles(watcher);
 ...
 */
export async function getDocumentManager() {
    _defaultManager ??= createDocumentManager();
    return _defaultManager;
}
//# sourceMappingURL=document-manager-factory.js.map