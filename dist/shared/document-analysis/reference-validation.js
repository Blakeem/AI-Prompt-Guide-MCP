 ...
 */
export async function detectBrokenReferences(manager, _namespace, title, overview) {
    // Input validation
    if (manager == null) {
        throw new DocumentAnalysisError('Document manager is required', 'detectBrokenReferences', [], ['Ensure document manager is properly initialized']);
    }
    ...
    try {
        ...
        throw new DocumentAnalysisError(`Broken reference detection failed: ${error}`, 'detectBrokenReferences', [], [
