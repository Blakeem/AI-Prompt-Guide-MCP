 ...
 * ```
 */
export declare class DocumentAnalysisError extends AddressingError {
    operation: string;
    partialResults?: unknown | undefined;
    recoverySuggestions?: string[] | undefined;
    constructor(message: string, operation: string, partialResults?: unknown | undefined, recoverySuggestions?: string[] | undefined);
}
/**
