...
Second task with workflow.`;
            ...
            vi.doMock('../../../prompts/workflow-prompts.js', () => ({
                getWorkflowPrompt: vi.fn((name) => name === 'simplicity-gate' ? mockWorkflow : undefined),
...
Second task.`;
            ...
            vi.doMock('../../../prompts/workflow-prompts.js', () => ({
                getWorkflowPrompt: vi.fn((name) => name === 'simplicity-gate' ? mockTaskWorkflow : undefined),
...
//# sourceMappingURL=complete-subagent-task.test.js.map