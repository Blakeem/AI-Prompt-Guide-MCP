 ...
 */
export async function viewCoordinatorTask(args, _state, manager) {
    ...
    if (args['slug'] != null) {
        ...
        mode = 'detail';
        if (slugParam === '') {
            throw new AddressingError('Task slug cannot be empty', 'EMPTY_TASK_SLUG');
        }
...
//# sourceMappingURL=view-coordinator-task.js.map