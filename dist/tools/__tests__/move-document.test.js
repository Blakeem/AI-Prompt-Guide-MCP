...
describe('move_document Tool', () => {
    ...
    let testSourcePath;
    let testDestPath;
    let testNestedDestPath;
    let testSourceAbsolutePath;
    let testDestAbsolutePath;
    let testNestedDestAbsolutePath;
    let cache;
    let manager;
    let tempDir;
    let sessionState;
...
`;
    ...
    it('should throw error when source document does not exist', async () => {
        ...
        await expect(moveDocument({
            from: '/docs/api/non-existent.md',
            to: testDestPath,
        }, sessionState, manager)).rejects.toThrow();
    });
    it('should throw error when destination document already exists', async () => {
        ...
        await expect(moveDocument({
            from: testSourcePath,
            to: testDestPath,
        }, sessionState, manager)).rejects.toThrow(/already exists/i);
...
//# sourceMappingURL=move-document.test.js.map