...
export class TestEnvironment {
     ...
     */
    enableErrorSimulation(enabled = true) {
        if (this.useRealFileSystem) {
 ...
 */
export function setupTestSuite(_suiteName, options = {}) {
    let testEnvironment;
    return {
        beforeAll: async () => {
