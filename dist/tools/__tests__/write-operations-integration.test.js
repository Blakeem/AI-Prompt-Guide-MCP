...
`;
    ...
    it('should successfully edit a section in an existing document', async () => {
        ...
        await expect(manager.updateSection(testDocPath, 'overview', newContent, { updateToc: false })).resolves.not.toThrow();
    ...
    it('should successfully insert a new section in an existing document', async () => {
        ...
        await expect(manager.insertSection(testDocPath, 'authentication', 'insert_after', 2, 'New Section', 'This is new content', { updateToc: false })).resolves.not.toThrow();
    ...
    it('should successfully delete a section from an existing document', async () => {
        ...
        await expect(manager.deleteSection(testDocPath, 'rate-limits', { updateToc: false })).resolves.not.toThrow();
...
//# sourceMappingURL=write-operations-integration.test.js.map