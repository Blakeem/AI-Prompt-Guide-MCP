 ...
 */
import { createDocument, browseDocuments, searchDocuments, section, move, deleteDocument, moveDocument, viewDocument, viewSection, viewSubagentTask, viewCoordinatorTask, subagentTask, completeSubagentTask, startSubagentTask, coordinatorTask, completeCoordinatorTask, startCoordinatorTask, editDocument, executeGetWorkflow, executeGetGuide } from './implementations/index.js';
/**
 ...
 */
export async function executeTool(toolName, args, state, manager, onListChanged) {
