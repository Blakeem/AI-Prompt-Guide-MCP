 ...
 */
export function detectCycles(context, targetPath) {
...
export async function findForwardLinks(manager, docPath, document, context, classifyRelationship) {
    const forwardLinks = [];
 ...
 */
// ts-unused-exports:disable-next-line
export async function findBackwardLinks(manager, docPath, context, classifyRelationship) {
    const backwardLinks = [];
    try {
 ...
 */
// ts-unused-exports:disable-next-line
export function buildDependencyChain(relatedDocs) {
    ...
    const implementations = relatedDocs.filter(doc => doc.relationship === 'consumes_api' ||
 ...
 */
// ts-unused-exports:disable-next-line
export function determineCompletionStatus(doc) {
 ...
 */
export async function analyzeDocumentLinks(manager, docPath, linkDepth, classifyRelationship, findRelatedByContent) {
    try {
