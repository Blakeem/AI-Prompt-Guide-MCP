 ...
 */
export function parseSectionPath(fullPath) {
 ...
 */
export function generateBreadcrumb(docPath) {
 ...
 */
export async function getFolderStructure(manager, basePath, targetPath, verbose = false) {
    const folders = [];
    const documents = [];
...
//# sourceMappingURL=folder-navigator.js.map