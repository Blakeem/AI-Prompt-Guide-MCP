 ...
 */
export declare const COMPLETE_COORDINATOR_TASK_CONSTANTS: {
    readonly MAX_NOTE_LENGTH: 1000;
};
/**
 * Get the input schema for complete_coordinator_task tool
 */
export declare function getCompleteCoordinatorTaskSchema(): CompleteCoordinatorTaskInputSchema;
//# sourceMappingURL=complete-coordinator-task-schemas.d.ts.map