 ...
 */
export function getCreateDocumentSchema(stage) {
 ...
 */
export function determineCreateDocumentStage(args) {
 ...
 */
export function getNextCreateDocumentStage(currentStage) {
 ...
 */
export function getDocumentNamespaces() {
    return Object.values(DOCUMENT_NAMESPACES);
}
/**
 * Get namespace configuration by ID
 */
export function getNamespaceConfig(namespaceId) {
    const namespace = DOCUMENT_NAMESPACES[namespaceId];
    return namespace ?? null;
}
//# sourceMappingURL=create-document-schemas.js.map