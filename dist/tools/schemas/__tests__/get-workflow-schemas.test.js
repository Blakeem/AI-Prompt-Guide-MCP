...
describe('generateGetWorkflowSchema', () => {
    ...
    describe('description formatting', () => {
        ...
        test('should include workflow descriptions from YAML frontmatter', () => {
            ...
            const hasWorkflowName = workflow.enum.some(name => workflow.description.includes(name));
...
//# sourceMappingURL=get-workflow-schemas.test.js.map