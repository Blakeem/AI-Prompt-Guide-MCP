...
export class ReferenceExtractor {
  ...
  private static readonly REFERENCE_PATTERN = /@(?:\/[^\s\]),;:!?]+(?:#[^\s\]),;:!?]*)?|#[^\s\]),;:!?]*)/g;
   ...
   */
  private normalizeReference(ref: string, contextPath: string): NormalizedReference {
   ...
   */
  private normalizeDocumentPath(docPath: string): string {
    if (docPath === '') {
